#! /usr/bin/env python
# This code is to preprocess the original data.
# More specifically, it takes the original data,
# split them into train
...
test_user, test_time, test_lati, test_longi, test_loc \
    = data_loader.load_data(train_file)
